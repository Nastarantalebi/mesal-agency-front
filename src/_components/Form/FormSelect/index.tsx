  ...
  return (
    <select
      ...
      className={
        "bg-size-[20px_auto] " +
        twMerge([
          "disabled:bg-slate-100 disabled:cursor-not-allowed disabled:dark:bg-darkmode-800/50 cursor-pointer",
          "[[readonly]]:bg-slate-100 [[readonly]]:cursor-not-allowed [[readonly]]:dark:bg-darkmode-800/50",
          "bg-chevron-black transition duration-200 ease-in-out w-full text-sm border-slate-300/60 shadow-sm rounded-md py-2 px-3 pe-8 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50",
