    ...
    >
      <input
        ...
        className={clsx(
          ...
          "transition duration-200 ease-in-out w-full text-sm border border-slate-400/50  p-2 rounded-sm placeholder:text-slate-400/90 focus:ring-1 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 dark:placeholder:text-slate-500/80",
      ...
      {/* بخش نمایش حروف */}
      {showValueInWord && money && valueInWords && (
        <span
