import RoomTypeBeds from "@/app/AdminPanel/RoomTypes/components/roomType/RoomTypeBeds";
...
export const RoomTypeTabsData = ({ AccommodationId, roomTypeId }: Props) => [
  {
    title: "اطلاعات",
    component: (
      <RoomTypeForm AccommodationId={AccommodationId} RoomTypeId={roomTypeId} />
    ),
  },
  {
    title: "عکس ها",
    component: (
      <RoomTypeImg AccommodationId={AccommodationId} RoomTypeId={roomTypeId} />
    ),
  },
  {
    title: "ویژگی ها",
  ...
  },
  {
    title: "نوع تخت",
    component: (
      <RoomTypeBeds RoomTypeId={roomTypeId} AccommodationId={AccommodationId} />
    ),
  },
  {
    title: "اتاق ها",
  ...
  },
  {
    title: "قیمت",
    component: (
      <PriceForm RoomTypeId={roomTypeId} AccommodationId={AccommodationId} />
    ),
  },
];
