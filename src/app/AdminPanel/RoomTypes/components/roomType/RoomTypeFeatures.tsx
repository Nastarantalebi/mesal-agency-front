                        ...
                        {getFeatures.data.results?.map((f) => {
                          ...
                          return (
                            <Badge
                              ...
                              className={`cursor-pointer px-6 py-2 ${isAdded ? "cursor-not-allowed bg-accent/20 border-accent" : ""} ${selected ? "bg-green-400/10 text-black border-green-400 cursor-pointer" : ""}`
