...
export const tourTemplateValidation = z.object({
  title: z.string().min(3, "عنوان تور باید حداقل ۳ کاراکتر باشد"),
  category: z.string("فیلد الزامی است").min(1, "فیلد الزامی است"),
  ...
  vehicle_details: z.string("فیلد الزامی است"),
  transportation_included: z.boolean("فیلد الزامی است"),
  destination: z.string().min(1, "این فیلد الزامی است."),
  country: z.string().optional().nullable(),
  difficulty: z.string("فیلد الزامی است"),
  age_requirement: z.number().int().min(0),
  highlights: z.string().optional(),
  is_featured: z.boolean("فیلد الزامی است"),
...
export const tourDepartureValidation = z.object({
  ...
  available_seats: z
    .number()
    .int()
    .min(1, "ظرفیت باقی مانده باید بیشتر از ۱ باشد."),
